...
def ocr_images(image_files, credentials_path='googlecredentialsocrkeysetting.json', output_dir='visionocr_result'):
    ...
    for img_path in image_files:
        ...
        cleaned = re.sub(r'[^a-zA-Z0-9]', '', full_text).upper()  # 줄바꿈, 공백 제거하고 대문자로
        results[os.path.basename(img_path)] = cleaned
